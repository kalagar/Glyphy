...
> **Distribution:** Glyphy is available on the [Edge Add-ons store](https://microsoftedge.microsoft.com/addons/). You can also sideload from the Chrome Web Store — Edge accepts Chrome extensions directly.
